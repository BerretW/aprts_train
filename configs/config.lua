...
Config.keys = {
    ...
    repair    = 0x4CC0E2FE, -- Default: 0x4CC0E2FE [B]
...
Config.webhookLink = 'https://discord.com/api/webhooks/1318277103703167076/V4-v1x1VtmSPNz7GjZZum3lVNavtmeeMPfMaeSsnGNnmar0UujhbNcV30hbVofnU0brx' -- Insert Webhook Link to Enable
Config.webhookTitle = 'BCC-Train' -- Insert Webhook Title
Config.webhookAvatar = 'Mašinfíra' -- Insert Webhook Avatar
-----------------------------------------------------
Config.Job = "conductor"
Config.maxTrains = 5        -- Max Number of Trains a Player may Own
Config.maxActiveTrains = 3  -- Max Number of Trains physically on the tracks at once (per server)
-----------------------------------------------------

Config.sellPrice = 0.01 -- Default: 0.60 / Sell Price is 60% of Purchase Price
-----------------------------------------------------
...
-- Teplota kotle (boiler temperature)
Config.boilerTemp = {
    buildTime       = 120,  -- sekund od 0 do 100 % teploty při běžícím motoru
    drainTime       = 60,   -- sekund od 100 do 0 % po zastavení motoru
    minEfficiency   = 0.7,  -- koeficient výkonu při 0 % teplotě
    maxEfficiency   = 1.2,  -- koeficient výkonu při 100 % teplotě
    boostItem       = 'chemic_oil',
    boostItemName   = 'Pixla oleje',
    boostAmount     = 40,   -- navýšení teploty o X % nad 100 (max teplota = 140 %)
    boostDuration   = 60,   -- sekund trvání boostu
    boostEfficiency = 1.8,  -- koeficient výkonu při plném boostu (teplota 140 %)
}
-----------------------------------------------------

Config.fuel = {
    item = 'mining_bag_coal',         -- Item Name in the Database
    itemName = 'Pytel uhlí',   -- Item Display Name
}
-----------------------------------------------------

Config.condition = {
    item = 'chemic_oil',      -- Item Name in the Database
    itemName = 'Stroní olej', -- Item Display Name
}
-----------------------------------------------------

Config.bacchusBridge = {
    enabled = false,                             -- Blow Up Bacchus Bridge!
    coords = vector3(492.01, 1774.41, 182.5),   -- Coords of Location to Place Dynamite
    item = 'tool_dynamite',                          -- Item Name in Database
    itemAmount = 2,                             -- Number of Items Needed
    timer = 30                                  -- Time in Seconds Before Explosion
}
-----------------------------------------------------

Config.despawnDist = 500 -- Maximum Distance Conductor can be from Train Before it Despawns
-----------------------------------------------------
